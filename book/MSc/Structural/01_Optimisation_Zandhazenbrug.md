...
Firstly, a stakeholder analysis is done to map the stakeholders in a power-interest grid and gather all the requirements. These requirements were then used to set up several criteria for the multi-criteria decision analysis.
...
1. A bridge without a centre pillar
2. Tunnel under the highway
3. Bridge with a centre pillar
...
The last step of the optimization was to perform a Multi-Objective Design Optimization (MODO). The IMAP and MINMAX algorithms were used to find the optimal design that balances stakeholder's needs. The result of the algorithms is shown in the figure below. 
